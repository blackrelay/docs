...
2. Learn the world architecture: [World, Chain And Client](world-chain-client/).
3. Pick a practical workflow: [Development Workflows](development-workflows/).
4. Learn direct inspection: [Sui CLI And GraphQL](sui-cli-graphql/).
5. Learn the assembly model: [Smart Assemblies](smart-assemblies/).
6. Build a small read-only public-data tool: [Quickstart](../quickstart/).
7. Design one programmable assembly workflow: [Programmable SSUs](programmable-ssus/) or [Gates, Turrets And Routes](gates-turrets-routes/).
