...
That means a public tool can start with indexed source-labelled records instead of immediately operating:
...
Use Black Relay to make public information readable while keeping source labels visible.
